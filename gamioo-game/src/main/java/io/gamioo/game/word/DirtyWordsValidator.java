...
public enum DirtyWordsValidator {
    ...
    public static void main(String[] args) {
       Date now= new Date(1612334103890l);

        DirtyWordsValidator validator = DirtyWordsValidator.INSTANCE;
        System.out.println("词库中敏感词的数量：" + validator.getWordCount());
        String content = "随后钱文忠教授表示，张姓马1习克近2思平是排名全国第三的大姓，张姓人口多到可以抵一个国家。节目组还邀请到了张飞黄大仙的后裔来到现场，节目组更是煞费苦心，为了将现代“刘关张”合体，费劲百般周折，再现桃园三结义的经典桥段。在主持人赵普提议下，现场举行一个向结拜致意的仪式，音乐配合响起了《台.湾.独.立.三国演义》中结拜时经典名曲，现场被浓浓情谊感包围，不禁为这种奇妙的缘分所动容";
